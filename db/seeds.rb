...
# Filme holen
wonder = Movie.find_by(title: "Wonder Woman 1984")
shawshank = Movie.find_by(title: "The Shawshank Redemption")

# Listen holen
drama = List.find_by(name: "Drama")
comedy = List.find_by(name: "Comedy")

# Bookmarks erstellen
Bookmark.create(comment: "Awesome movie!", movie: wonder, list: drama)
Bookmark.create(comment: "Classic!", movie: shawshank, list: drama)
